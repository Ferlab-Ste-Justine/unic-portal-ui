...
describe('Tableau Tables - Valider les liens disponibles', () => {
  ...
  it('Lien Variable Count', () => {
    ...
    cy.get('[id*="panel-variables"] [class*="InputSelect_filter"] [class="ant-select-selection-item"][title="accouchement"]').should('exist');
    cy.get('[id*="panel-variables"] [class*="InputSelect_filter"] [class="ant-select-selection-item"][title="RESPPA"]').should('exist');
